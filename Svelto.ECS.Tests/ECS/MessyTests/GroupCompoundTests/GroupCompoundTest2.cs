...
namespace Svelto.ECS.Tests.GroupCompounds
{
    ...
    public class GroupCompoundTest2
    {
        ...
        public void Test()
        {
            ...
            //Assert 2 instead of 8 since GroupCompounds dont exist until the developer requests them.
            Assert.That(GroupTag<DOOFUSES>.Groups.count, Is.EqualTo(2));
            Assert.That(GroupTag<EATING>.Groups.count, Is.EqualTo(2));
            Assert.That(GroupTag<RED>.Groups.count, Is.EqualTo(2));
            Assert.That(GroupTag<ENABLED>.Groups.count, Is.EqualTo(2));
        }
    }
}